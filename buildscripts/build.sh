...
cp prefix/$ARCH/lib/{libopenal,libSDL2,libhidapi,libGLESv2}.so ../app/src/main/jniLibs/$ABI/
...
cp "./build/$ARCH/gl4es-prefix/src/gl4es-build/obj/local/$ABI/libGLESv2.so" "./symbols/$ABI/"
